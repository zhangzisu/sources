...
int main() {
    ...
    for (int i = 1; i <= n; i++) std::cin >> type[i], his[i].push_back(i);
    for (int i = 1; i <= m; i++) std::cin >> val[first[fuck[i]]];
